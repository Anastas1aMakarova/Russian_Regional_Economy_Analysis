...
## Визуализация данных
Код для визуализации данных был написан с использованием средств python. Полностью код можно посмотреть на [Githab](https://github.com/Anastas1aMakarova/Russian_Regional_Economy_Analysis).
